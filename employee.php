...
<!-- delete
 ...
 <div class="col-md-12 ">
 <div align="center">
    <center>  <form name="sentMessage" id="contactForm" novalidate method="post" action="employee.php">
 ...
 <!--  <input name="code" id="id" style="width:350px;" class="form-control" rows="1" placeholder="code" required>
